...
var smsvStore_1 = require('./smsvStore')
var lodash_es_1 = require('lodash-es')
var SMSVControls = [
  agreement_1.Agreement,
  codeVerification_1.CodeVerification,
  imageVerification_1.ImageVerification,
...
var Container = /** @class */ (function(_super) {
  ...
  function Container(props) {
    ...
    _this.store = new smsvStore_1.SmsvStore()
    ...
    _this.generateChildren = function() {
      _this.props.children.forEach(function(child, index) {
        var cloned = lodash_es_1.cloneDeep(child)
        ...
        return __generator(this, function(_a) {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                this.props.onFetchCode(this.smsvInfo.phoneNumber),
              ]
            case 1:
              res = _a.sent()
    ...
    _this.updateCodeControlStatus = function() {
      var isCodeDependencyDisable = !!Object.values(
        _this.smsvControlStatusCache
      ).find(function(x) {
        return !x.isVerified && x.isCodeDependency
      })
      _this.store.changeCodeVerificationStatus(!isCodeDependencyDisable)
    }
    _this.updateSubmitStatus = function() {
      var isSubmitDisable = !!Object.values(_this.smsvControlStatusCache).find(
        function(x) {
          return !x.isVerified
        }
      )
...
exports.default = {
  ...
  CodeVerification: codeVerification_1.CodeVerification,
  ImageVerification: imageVerification_1.ImageVerification,
