var VerificationCodeRender = /** @class */ (function () {
    function VerificationCodeRender(parameters) {
        ...
        this.getRandomText = function () {
            var _a = _this, codeLen = _a.codeLen, getRandomNumber = _a.getRandomNumber;
            var pool = 'ABCDEFGHJKLMNPQRSTUVWXYZabcdefhijkmnpqrstuvwxyz234568';
            var drawText = [], drawImageText = '';
        ...
        this.drawVerificationCode = function () {
            var _a = _this, targetCanvas = _a.targetCanvas, codeLen = _a.codeLen, getRandomNumber = _a.getRandomNumber, getRandomColor = _a.getRandomColor, getRandomText = _a.getRandomText, width = _a.width, height = _a.height;
            var ctx = targetCanvas.getContext('2d');
            ctx.fillStyle = getRandomColor(180, 230);
            ctx.fillRect(0, 0, width, height);
            var _b = getRandomText(), drawImageText = _b.drawImageText, drawText = _b.drawText;
            for (var i = 0; i < 4; i++) {
            ...
            for (var i = 0; i < 40; i++) {
                ctx.beginPath();
                ctx.arc(getRandomNumber(0, width), getRandomNumber(0, height), 1, 0, 2 * Math.PI);
                ctx.closePath();
        ...
        var targetCanvas = parameters.targetCanvas, codeLen = parameters.codeLen, _a = parameters.width, width = _a === void 0 ? 100 : _a, _b = parameters.height, height = _b === void 0 ? 30 : _b;
