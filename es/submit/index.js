...
var Submit = /** @class */ (function (_super) {
    ...
    Submit.prototype.render = function () {
        ...
        var _a = this.props.btnText, btnText = _a === void 0 ? '登录' : _a;
        return (React.createElement("div", { className: "smsv-submit-container" },
            React.createElement(Button, { disabled: isBtnEnable, onClick: this.onClick }, btnText)));
    };
    return Submit;
}(Component));
export { Submit };
