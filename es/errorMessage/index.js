...
var ErrorMessage = /** @class */ (function (_super) {
    ...
    ErrorMessage.prototype.render = function () {
        if (this.state.error) {
            return (React.createElement("div", { className: "smsv-error-message-container" },
                React.createElement("span", { className: "smsv-error-message-error-tips" }, this.state.error)));
        }
        else {
