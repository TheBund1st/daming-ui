...
var PhoneNumber = /** @class */ (function (_super) {
    ...
    function PhoneNumber() {
        ...
        _this.onPhoneNumberChange = function (event) {
            ...
            _this.setState({ phoneNumber: phoneNumber, inputPhoneNumberErrorStatus: inputPhoneNumberErrorStatus });
            _this.smsvStore.changeSMSVStatus(!inputPhoneNumberErrorStatus, _this.componentKey);
        ...
        _this.onBlur = function () {
            ...
            var validation = _this.props.validation;
            var inputPhoneNumberErrorStatus = validation(phoneNumber);
            _this.setState({ inputPhoneNumberErrorStatus: inputPhoneNumberErrorStatus });
        };
        return _this;
    }
    ...
    PhoneNumber.defaultProps = {
        ...
        suffix: React.createElement("span", null, "\u8BF7\u586B\u5199\u63A5\u6536\u9A8C\u8BC1\u7801\u7684\u624B\u673A\u53F7\u7801"),
