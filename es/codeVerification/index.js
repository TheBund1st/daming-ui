...
var CodeVerification = /** @class */ (function (_super) {
    ...
    function CodeVerification(props) {
        ...
        _this.setInterval = function () {
            ...
            _this.setState({
                isBtnDisable: true,
                codeVerificationBtnText: _this.intervalLeftSecond-- + "\u79D2\u540E\u91CD\u8BD5",
            });
    ...
    CodeVerification.prototype.render = function () {
        var _a = this.state, codeVerification = _a.codeVerification, placeHolder = _a.placeHolder, codeVerificationBtnText = _a.codeVerificationBtnText, isBtnDisable = _a.isBtnDisable, inputCodeVerificationErrorStatus = _a.inputCodeVerificationErrorStatus, errorTips = _a.errorTips;
        return (React.createElement("div", { className: "smsv-code-verification-container" },
            React.createElement("div", { className: "smsv-code-verification-action-container" },
                React.createElement(Input, { value: codeVerification, placeholder: placeHolder, onChange: this.onCodeVerificationChange, onBlur: this.onBlur }),
                React.createElement(Button, { type: "primary", disabled: isBtnDisable, onClick: this.sendCode }, codeVerificationBtnText)),
            inputCodeVerificationErrorStatus && (React.createElement("div", { className: "smsv-code-verification-error-tips" }, errorTips))));
    };
