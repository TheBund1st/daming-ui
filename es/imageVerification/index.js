...
var ImageVerification = /** @class */ (function (_super) {
    ...
    function ImageVerification() {
        ...
        _this.onVerificationCodeChange = function (event) {
            ...
            var _a = _this.state, drawImageText = _a.drawImageText, inputImageNumberErrorStatus = _a.inputImageNumberErrorStatus;
    ...
    ImageVerification.prototype.onBlur = function () {
        var _a = this.state, verificationCode = _a.verificationCode, drawImageText = _a.drawImageText, inputImageNumberErrorStatus = _a.inputImageNumberErrorStatus;
        ...
        this.smsvStore.changeSMSVStatus(!inputImageNumberErrorStatus, this.componentKey);
        this.setState({
            inputImageNumberErrorStatus: inputImageNumberErrorStatus,
        });
    };
    ImageVerification.prototype.render = function () {
        var _this = this;
        var _a = this.state, verificationCode = _a.verificationCode, inputImageNumberErrorStatus = _a.inputImageNumberErrorStatus, errorTips = _a.errorTips;
        var codeLength = this.props.codeLength;
        return (React.createElement("div", { className: "smsv-image-verification-container" },
            React.createElement("div", { className: "smsv-input-canvas-container" },
                React.createElement("div", { className: "smsv-input-container" },
                    React.createElement(Input, { maxLength: codeLength, value: verificationCode, placeholder: "\u8BF7\u8F93\u5165\u53F3\u4FA7\u9A8C\u8BC1\u7801", prefix: React.createElement(Icon, { type: "robot" }), onChange: this.onVerificationCodeChange, onBlur: function () {
                            _this.onBlur();
                        }, className: inputImageNumberErrorStatus
                            ? 'smsv-image-verification-error-input'
                            : '' })),
                React.createElement("div", { className: "smsv-image-verification-action-container" },
                    React.createElement("canvas", { id: "smsv-image-verification-canvas", width: "100px", height: "30px", ref: this.getCanvasRef }),
                    React.createElement("div", { className: "smsv-image-verification-refresh", onClick: this.refreshImage },
                        React.createElement(Icon, { type: "sync" })))),
            inputImageNumberErrorStatus && (React.createElement("div", { className: "smsv-image-verification-error-tips" }, errorTips))));
    };
